!(function(doc){
    var itemClassName = "carousel_photo";
        items = doc.getElementsByClassName(itemClassName),
    ...
    function setEventListeners() {
        var next = doc.getElementsByClassName('carousel_button--next')[0],
            prev = doc.getElementsByClassName('carousel_button--prev')[0];
